      ...
      <div className={styles.referenzenContent}>
        <div className={styles.textContainer}>
          ...
          <p>
            ...
            maßgefertigter Spengler-Arbeiten für das renommierte 5-Sterne-Hotel
            im Herzen Wiens.
          </p>
        </div>
        <div className={styles.textContainer}>
          ...
          <p>
            Umfangreiche Restaurierungsarbeiten an den historischen
            Dachelementen und Regenrinnen des UNESCO-Weltkulturerbes.
          </p>
        </div>
        <div className={styles.textContainer}>
        ...
        <div className={styles.textContainer}>
          ...
          <p>
            Fachgerechte Restaurierung historischer Metallelemente und
            Herstellung von Spezialanfertigungen für das prestigeträchtige
            Museum.
          </p>
        </div>
        <div className={styles.textContainer}>
